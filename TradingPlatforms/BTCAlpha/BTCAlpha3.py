...
class Client:
    ...
    def get_currencies(self):
        ...
        """
        return self._query('get', 'v1/currency/')
    ...
    def get_pairs(self, **kwargs):
        ...
        """
        return self._query('get', 'v1/pair/', params=kwargs)
    ...
    def get_sell_orders(self, **kwargs):
        ...
        :param kwargs: Filters (Optional): pair, status(1: active, 2: canceled, 3: done), limit
        :return: orders array

        Example: [{'amount': '0.00000000', 'pair': 'BTC_USD', 'type': 1, 'status': 3, 'price': '845.33000000',
                'id': 11259}, ...]
        """
        kwargs['type'] = 1
        return self._query('get', 'v1/order/', params=kwargs)

    def get_buy_orders(self, **kwargs):
    ...
    def get_own_sell_orders(self, **kwargs):
        ...
        kwargs['type'] = 1
        return self._query('get', 'v1/order/list_own/', params=kwargs, auth=True)
    ...
    def cancel_order(self, oid):
        ...
        """
        data = {'order': oid}
        return self._query('post', 'v1/cancel-order/', data=data, auth=True)
    ...
    def get_exchanges(self, **kwargs):
        ...
        Example: [{'id': 6030, 'price': '839.36000000', 'pair': 'BTC_USD', 'type': 1, 'timestamp': 1483705817.735508,
                'amount': '0.00281167'}, ....]
        """
        return self._query('get', 'v1/exchange/', params=kwargs)
    ...
    def get_own_exchanges(self, **kwargs):
        ...
        """
        return self._query('get', 'v1/exchange/own_all/', params=kwargs, auth=True)

    def get_own_sell_exchanges(self, **kwargs):
        return self._query('get', 'v1/exchange/own_sell/', params=kwargs, auth=True)

    def get_own_buy_exchanges(self, **kwargs):
        return self._query('get', 'v1/exchange/own_buy/', params=kwargs, auth=True)
    ...
    def get_deposits(self):
        ...
        """
        return self._query('get', 'v1/deposit/', auth=True)
    ...
    def get_withdraws(self, **kwargs):
        ...
        return self._query('get', 'v1/withdraw/', params=kwargs, auth=True)
    ...
    def _get_headers(self, data):
        msg = self.key + urlencode(sorted(data.items(), key=lambda val: val[0]))
